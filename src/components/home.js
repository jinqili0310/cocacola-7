 ...
 * @LastEditTime: 2020-11-06 21:02:45
 * @FilePath: /cocacola-7/src/components/home.js
 */
					...
					<Col className="col-card">
						<Card className="product-card product-cc">
							...
							<Card.Body className="product-card-body">
								...
								<Button variant="dark" className="button-style" href="/cocacola-7/#/products/coca-cola/explore/">
									EXPLORE
								</Button>
							</Card.Body>
						</Card>
